  ...
  return (
    <span
      style={{
        ...
        background: pricing ? "rgba(255,193,7,0.12)" : "rgba(244,67,54,0.1)",
        border: `1px solid ${pricing ? "rgba(255,193,7,0.35)" : "rgba(244,67,54,0.3)"}`,
        color: pricing ? "var(--warning)" : "var(--danger)",
        whiteSpace: "nowrap",
      }}
